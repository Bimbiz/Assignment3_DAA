...
public class Result {
     ...
     * @param graphVertices Number of vertices in the original graph
     * @param graphEdges Number of edges in the original graph
     */
    ...
    /**
     * Creates a new Result object with validation status and graph name.
     *
     * @param algorithmName Name of the algorithm used
     * @param mstEdges List of edges in the MST
     * @param totalCost Total cost of the MST
     ...
     * @param graphVertices Number of vertices in the original graph
     * @param graphEdges Number of edges in the original graph
     * @param isValid Whether the MST is valid
    ...
    /**
     * Gets the CSV header for result export.
     * @return CSV header
     */
