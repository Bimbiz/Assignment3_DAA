...
public class KruskalTest {
    ...
    public void testSmallGraph() {
        // Create graph: A-B-C-D with weights
        ...
        Result result = kruskal.findMST(graph);
    ...
    public void testValidationMethod() {
        ...
        boolean isValid = kruskal.validateMST(graph, result);
    ...
    public void testQuickValidation() {
        ...
        boolean isValid = kruskal.quickValidate(graph, result);
